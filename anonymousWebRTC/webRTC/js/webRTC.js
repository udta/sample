...
window.onload = function() {
	...
	if (JSON.parse(localStorage.getItem("webrtcSettings"))) {
		webrtcSettings = JSON.parse(localStorage.getItem("webrtcSettings"));
		txtPhoneNumber = webrtcSettings.phone_number;
	}
